...
#data set 1
ret1, data1, page_req_key1 = quote_ctx.request_history_kline('HK.00981', start=DayStr(today - timedelta(days=NumDay)), end='', max_count=150*NumDay, fields=KL_FIELD.ALL, ktype=KLType.K_3M) 
...
class RVICross(bt.Strategy):
    ...
    def __init__(self):
        ...
        tempobject = strgy.RVIin(self.data)
        tempobject.maperiod = self.RVIperiod
        self.IDC = tempobject
