...
ret1, data1, page_req_key1 = quote_ctx.request_history_kline('HK.00700', start='2009-12-11', end='2009-12-31', max_count=5000, fields=KL_FIELD.ALL, ktype=KLType.K_DAY) 
if ret1 == RET_OK:
    print('ok')
    #print(data1)
