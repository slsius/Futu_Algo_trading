...
#data set 1
ret1, data1, page_req_key1 = quote_ctx.request_history_kline('HK.00388', start=DayStr(today - timedelta(days=NumDay2)), end=DayStr(today - timedelta(days=NumDay)), max_count=110*NumDay, fields=KL_FIELD.ALL, ktype=KLType.K_3M) 
