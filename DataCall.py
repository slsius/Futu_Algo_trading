...
#data set 3
ret3, data3, page_req_key3 = quote_ctx.request_history_kline('HK.00700', start=today, end='', max_count=120, fields=KL_FIELD.ALL, ktype=KLType.K_3M) 
print(data.time_key, data.open)

#data set 4
ret4, data4, page_req_key4 = quote_ctx.request_history_kline('HK.00700', start=today, end='', max_count=120, fields=KL_FIELD.ALL, ktype=KLType.K_3M) 
print(data.time_key, data.open)

#data set 5
ret5, data5, page_req_key5 = quote_ctx.request_history_kline('HK.00700', start=today, end='', max_count=120, fields=KL_FIELD.ALL, ktype=KLType.K_3M) 
print(data.time_key, data.open)
